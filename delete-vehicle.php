...
if(isset($_POST['delete']))
  ...
  $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "DELETE FROM addvehicle  where ID='$eid'");
    if ($query) {
        echo "<script>alert('Vehicle Entry Details has been deleted');</script>";
...
<head>
    ...
    <title>FMS - Delete Vehicle</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Delete Vehicle Entry</strong>
                            </div>
...
?>              
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><?php  echo $row['color'];?></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><?php  echo $row['prdate'];?></div>
                                    </div>
