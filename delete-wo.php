...
if(isset($_POST['delete']))
  ...
  $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "DELETE FROM slog  where ID='$eid'");
    if ($query) {
...
<head>
    ...
    <title>FMS - Delete Work Order</title>
...
?>              
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><?php  echo $row['problem'];?></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><?php  echo $row['deldate'];?></div>
                                    </div>
