                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">View Daily Log</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">View Daily Log</strong>
                        </div>
                        <div class="card-body">
                             <table class="table">
                <thead>
...
$ret=mysqli_query($con,"SELECT addvehicle.brand, addvehicle.model, adddriver.dname, adddriver.dcno, dlog.dnid, dlog.regno, dlog.ID,dlog.route, dlog.startduty, dlog.endduty FROM addvehicle INNER JOIN adddriver ON addvehicle.regno=adddriver.regno INNER JOIN dlog ON addvehicle.regno = dlog.regno where dlog.dnid='$cid'");
$cnt=1;
