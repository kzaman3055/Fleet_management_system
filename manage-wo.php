                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="edit_vehicle.php">View Driver</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Edit Driver</strong>
                        </div>
                        <div class="card-body">
                             <table class="table">
                <thead>
