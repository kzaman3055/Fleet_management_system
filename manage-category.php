...
<head>
    ...
    <title>FMS - Manage Category</title>
...
?>
                ...
                <tr>
                  ...
                  <td><a href="edit-category.php?editid=<?php echo $row['ID'];?>">Edit Details</a>|<a href="delete-category.php?editid=<?php echo $row['ID'];?>">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
