...
if(isset($_POST['delete']))
  ...
  $eid=$_GET['editid'];
    ...
    if ($query) {
        echo "<script>alert('Category Details has been deleted');</script>";
...
<head>
    ...
    <title>FMS - Delete Catagory</title>
...
?>              
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Vehicle Catagory</label></div>
                                        <div class="col-12 col-md-9"><?php  echo $row['VehicleCat'];?></div>
                                    </div>
