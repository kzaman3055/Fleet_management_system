...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
        echo "<script>alert('Category Entry Details has been added');</script>";
...
<body>
   ...
   <?php include_once('includes/header.php');?>
    ...
    echo $msg;
                                   ...
                                   <p style="text-align: center;"> <button type="submit" class="btn btn-primary btn-sm" name="submit" >Add Category</button></p>
                                </form>
                            </div>
