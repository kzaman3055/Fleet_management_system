...
<head>
    ...
    <title>FMS - Driver Daily Log</title>
...
$ret=mysqli_query($con,"SELECT addvehicle.brand, addvehicle.model, adddriver.dname, adddriver.dcno, dlog.dnid, dlog.regno, dlog.ID,dlog.route, dlog.startduty, dlog.endduty FROM addvehicle INNER JOIN adddriver ON addvehicle.regno=adddriver.regno INNER JOIN dlog ON addvehicle.regno = dlog.regno where date(dlog.startduty)=CURDATE();");
$cnt=1;
