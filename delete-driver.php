...
if(isset($_POST['delete']))
  ...
  $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "DELETE FROM adddriver  where did='$eid'");
    if ($query) {
        echo "<script>alert('Driver Details has been deleted');</script>";
